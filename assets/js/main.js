document.addEventListener('DOMContentLoaded', (event) => {
    // Check if the animations have already been played in this session
    if (!sessionStorage.getItem('hasAnimated')) {
        ...
        const sr = ScrollReveal({
            duration: 1500,
            reset: false // Set reset to false to ensure the animation occurs only once
        });
        ...
        // Set the flag in session storage to indicate the animations have been played
